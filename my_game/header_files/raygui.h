...
RAYGUIAPI int GuiButtonEx(Rectangle bounds, const char *text, Rectangle rect, int key);
...
int GuiButtonEx(Rectangle bounds, const char *text, Rectangle rect, int key)
{
    int result = 0;
    GuiState state = guiState;
