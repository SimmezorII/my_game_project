...
R
EM set SOURCES=core_basic_window.c

set SOURCES=source_files\*.cpp

REM src\*.c src\submodule\*.c
...
set VC_INIT="C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Auxiliary\Build\vcvarsall.bat"
